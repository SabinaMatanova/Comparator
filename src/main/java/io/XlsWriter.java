...
public class XlsWriter {
    ...
    public static void writeXlsStatistics(List<Statistics> statisticsList, String filePath) throws IOException {
        ...
        avgScoreCellHeader.setCellValue("Средний балл за экзамен по профилю");
        avgScoreCellHeader.setCellStyle(headerStyle);
        Cell numberOfStudentsCellHeader = headerRow.createCell(0);
        ...
        Cell numberOfUniversitiesCellHeader = headerRow.createCell(0);
        ...
        Cell universitiesCellHeader = headerRow.createCell(0);
        ...
        for (Statistics statistics : statisticsList) {
            ...
            avgScoreCell.setCellValue(statistics.getProfile().getProfileName());
            Cell numberOfStudentsCell = dataRow.createCell(2);
            numberOfStudentsCell.setCellValue(statistics.getProfile().getProfileName());
            Cell numberOfUniversitiesCell = dataRow.createCell(3);
            numberOfUniversitiesCell.setCellValue(statistics.getProfile().getProfileName());
            Cell universitiesCell = dataRow.createCell(4);
            universitiesCell.setCellValue(statistics.getProfile().getProfileName());
